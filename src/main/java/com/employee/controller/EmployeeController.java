...
public class EmployeeController {
	...
	public String register(Employee117 emp, Model m) {
		Employee117 e1 = repo.save(emp);
		return "result";
	}
	...
	public String edit(@PathVariable Integer eid, Model m) {
		Employee117 emp = repo.findById(eid).get();
	...
	public String editsave(@RequestParam Integer eid, @RequestParam String name, @RequestParam String email,
			@RequestParam String password, @RequestParam String address, Employee117 emp, Model model) {
		repo.save(emp);
		return "redirect:/views";
	}
